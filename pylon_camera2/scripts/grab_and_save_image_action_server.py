...
from camera_control_msgs2.msg import GrabImagesAction, GrabImagesGoal
from camera_control_msgs2.msg import GrabAndSaveImageAction, GrabAndSaveImageResult
